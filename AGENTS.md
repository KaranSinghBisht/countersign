...
make demo               # eight rehearsed failures, < 1s
...
| Testing | 22 | 30 | 73% | Assisted | 360+ unit tests, integration (webhook adversarial table, 20-vs-3 concurrency, recon). No browser E2E, no OpenAPI, no contract suite. |
